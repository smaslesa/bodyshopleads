...
export const metadata: Metadata = {
  title: "Privacy Policy | Body Shop Leads",
  description: "Privacy Policy for Body Shop Leads collision repair website templates and services.",
}
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              ...
              <p className="text-gunmetal leading-relaxed">
                This information is used solely to connect you with qualified collision repair professionals and provide accurate estimates.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-8 text-gunmetal space-y-2">
                <li>Provide collision repair estimates and connect you with qualified shops</li>
                <li>Respond to your inquiries and provide customer support</li>
                <li>Improve our website functionality and user experience</li>
                <li>Send you relevant information about collision repair services</li>
            ...
            <section className="mb-12">
              ...
              <ul className="list-disc pl-8 text-gunmetal space-y-2 mb-4">
                <li><strong>Collision Repair Shops:</strong> To provide you with estimates and services</li>
            ...
            <section className="mb-12">
              ...
              <div className="bg-green/5 p-6 rounded-xl">
                ...
                <ul className="list-disc pl-6 text-gunmetal space-y-1">
                  <li>You request deletion via email to hello@bodyshopleads.com</li>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="text-gunmetal">
                      <strong>Email:</strong> hello@bodyshopleads.com
                    </p>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-navy mb-3">Data Deletion Requests</h3>
                    <p className="text-gunmetal">
                      <strong>Email:</strong> hello@bodyshopleads.com<br/>
