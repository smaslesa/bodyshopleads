  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white">
      <div className="container">
        ...
        >
          <h2 className="text-4xl font-bold mb-4">Your Competition's Website vs. Yours</h2>
          <p className="text-xl text-gray-600">Drag the slider to see the difference</p>
        </motion.div>

        <div 
          id="comparison-container"
          className="relative max-w-6xl mx-auto h-[600px] rounded-2xl overflow-hidden shadow-2xl cursor-ew-resize"
        ...
        >
          ...
          <div className="absolute inset-0 bg-gray-100">
            <div className="p-8">
              {/* Error Banner */}
              <div className="bg-red-500 text-white p-3 text-center mb-4 flex items-center justify-center gap-2">
                <span>⚠️</span>
                <span className="text-sm font-bold">NOT MOBILE RESPONSIVE • 8 SECOND LOAD TIME • BUILT IN 2003</span>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-4 font-mono text-blue-800 text-xl">
                    Welcome to Bob's Body Shop!
                  </p>
                ...
                <div className="text-center text-xs text-gray-500 mt-8">
                  Best viewed in Internet Explorer 6 | Webmaster: Bob's nephew (2003)
                </div>
              </div>
            </div>
          </div>
