          ...
          <div className="min-h-[500px]">
            <AnimatePresence mode="sync">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <h3 className="text-blue-700 text-xl hover:underline cursor-pointer">
                      Professional Auto Body Repair - Insurance Approved
                    </h3>
                    <p className="text-gray-600 text-sm mt-1">
                      Expert collision repair. Free estimates, quality work...
                    </p>
                  </div>
              ...
              {currentResult >= 3 && (
                ...
                >
                  <h3 className="text-blue-700 text-lg">Some Other Body Shop</h3>
